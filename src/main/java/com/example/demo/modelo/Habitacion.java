...
public class Habitacion {
	...
	@Transient
	private BigDecimal valorIncluido;
	...
	public BigDecimal getValorIncluido() {
		return valorIncluido;
	}

	public void setValorIncluido(BigDecimal valorIncluido) {
		this.valorIncluido = valorIncluido;
	}
